...
$(TARGET_TEST_LOG) : $(OBJ_TEST_LOG) $(OBJS_NET)
	$(CXX) $^ -o $@ $(LD_FLAGS) $(CXX_FLAGS)

$(TARGET_TEST_ADD_EVENT) : $(OBJ_TEST_ADD_EVENT) $(OBJS_NET)
	$(CXX) $^ -o $@ $(LD_FLAGS) $(CXX_FLAGS)

$(TARGET_TEST_THREAD_POOL) : $(OBJ_TEST_THREAD_POOL) $(OBJS_NET)
	$(CXX) $^ -o $@ $(LD_FLAGS) $(CXX_FLAGS)

$(TARGET_TEST_ACCEPTOR) : $(OBJ_TEST_ACCEPTOR) $(OBJS_NET)
	$(CXX) $^ -o $@ $(LD_FLAGS) $(CXX_FLAGS)
