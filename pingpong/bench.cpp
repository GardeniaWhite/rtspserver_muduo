#include <basemuduo/Logging.h>
#include <basemuduo/Thread.h>
#include <basemuduo/Channel.h>
#include <basemuduo/EventLoop.h>
...
std::pair<int, int> runOnce() //测试一次游戏的总时间（包含初始化时间）和事件处理时间
{
...
int main(int argc, char* argv[])
{
  ...
  g_pipes.resize(2 * numPipes);//扩容 200
  for (int i = 0; i < numPipes; ++i)
  {
  ...
  for (int i = 0; i < 25; ++i)
  {
    ...
    std::cout<<"total time and loop time (us):";
    printf("%8d %8d\n", t.first, t.second);
  }
